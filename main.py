...
def start_gui():
    ...
    Button(root, text='I am an Administrator', width=50, height=30, bg='#00ff99', command=AdminLoginWindow).place(
        relx=0.032, rely=0.22)
    Label(root, text='Administrator Login', font=('Arial', 20, 'bold'), bg='#f0f0f0').place(relx=0.058, rely=0.80)

    Button(root, text='I am an existing Traveller', width=50, height=30, bg='#00ff99',
           command=TravellerLoginWindow).place(relx=0.37, rely=0.22)
    Label(root, text='Traveller Login', font=('Arial', 20, 'bold'), bg='#f0f0f0').place(relx=0.42, rely=0.80)

    Button(root, text='I am a new Traveller', width=50, height=30, bg='#00ff99', command=RegisterUser).place(relx=0.7,
                                                                                                             rely=0.22)
